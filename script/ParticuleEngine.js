...
ParticleEngine.prototype.setValues = function( parameters )
{
	...
	this.particleMesh = new THREE.PointCloud();//new THREE.ParticleSystem();
}
...
ParticleEngine.prototype.initialize = function(scene)
{
	...
	this.particleMesh = new THREE.PointCloud( this.particleGeometry, this.particleMaterial );//THREE.ParticleSystem( this.particleGeometry, this.particleMaterial );
